...
namespace Konstructor.FormsAndDS
{
    public partial class email : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SendMail("smtp.mail.ru", "ewpuk@mail.ru", "gfhjkmjngjxns89", MAIL, textBox2.Text, textBox3.Text);
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    if (reader.HasRows)
                    {
                        if (reader.Read())
                        {
                            info = "ул."+Convert.ToString(reader["Adress"]) +", тел."+ Convert.ToString(reader["Phone"]+", mail - "+Convert.ToString(reader["Email"]));
